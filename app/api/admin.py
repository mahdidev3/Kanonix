...
async def sales_report(session: DbSession, _=Depends(require_role(Role.admin, Role.superadmin)), kanoon=Depends(resolve_tenant)):
...
async def sales_report_csv(session: DbSession, _=Depends(require_role(Role.admin, Role.superadmin)), kanoon=Depends(resolve_tenant)):
...
async def attendee_report(session: DbSession, _=Depends(require_role(Role.admin, Role.superadmin)), kanoon=Depends(resolve_tenant)):
...
async def seat_status(session: DbSession, _=Depends(require_role(Role.admin, Role.superadmin)), kanoon=Depends(resolve_tenant)):
